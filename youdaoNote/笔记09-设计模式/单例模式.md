...
有些人认为使用 volatile 的原因是可见性，也就是可以保证线程在本地不会存有 instance 的副本，每次都是去主内存中读取。但其实是不对的。使用 volatile 的主要原因是其另一个特性：**禁止指令重排序优化**。参考 双重模式原理 https://blog.csdn.net/li295214001/article/details/48135939
...
摘自：http://wuchong.me/blog/2014/08/28/how-to-correctly-write-singleton-pattern/
